...
CPPUNIT_TEST_SUITE_REGISTRATION(Test_SynchronizationManager);
//////////////////////////////////////////////////////

void Test_SynchronizationManager::TestInstance()
{
    // Sets the objects up and processes.
    SynchronizationManager sysMan1 = SynchronizationManager::Instance();
    SynchronizationManager sysMan2 = SynchronizationManager::Instance();

    // Checks the result.
    CPPUNIT_ASSERT(&sysMan1 == &sysMan2);
/*
	// Set up
